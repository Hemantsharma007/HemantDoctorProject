                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input list="gender" required="" name="gender" autocomplete="off">
                                                    <datalist id="gender">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input list="degree" required="" name="degree" autocomplete="off">
                                                    <datalist id="degree">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input list="Department" required="" name="Department" autocomplete="off">
